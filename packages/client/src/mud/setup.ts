...
import { type Network, configureNetworkWithWallet, setupNetwork } from "./setupNetwork"
import type { MUDInterface, WalletClientWithAccount } from "./types"
...
function configureMudWithWallet(mud?: MUDInterface, wallet?: WalletClientWithAccount): MUDInterface | undefined {
